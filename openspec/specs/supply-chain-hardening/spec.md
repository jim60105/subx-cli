...
Reduce exposure to unmaintained crates, unnecessary transitive
dependencies, and known vulnerability advisories by keeping the
dependency graph minimal and gating CI on `cargo audit`.
